...
- `store/spssAccessibility-1.1.2.json`: draft metadata matching the Add-on Store schema. Update the URL and checksum after publishing the GitHub release asset.
